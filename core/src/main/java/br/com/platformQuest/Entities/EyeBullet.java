 ...
 * @author zorte
 */
public class EyeBullet extends Box2DEntity implements Update, Collisions{
    private float speedX;
    private float speedY;

    public EyeBullet(float x, float y, World world, Texture tex) {
        super(x, y, world, tex);
    ...
    public void shot() {
        ...
        float directionX = targetX - 22.5f;
        float directionY = 0;
    ...
    public void destroyObject() {
        Runnable destroyOnRun = new Runnable() {
            ...
            public void run() {
                ...
                EntitiesManager.getInstance().removeEntity(EyeBullet.this);
            }
        };
